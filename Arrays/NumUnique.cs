...
//will be grouped together. For example, if a variable called list stores
//the following values:

//int[] list = { 5, 7, 7, 7, 8, 22, 22, 23, 31, 35, 35, 40, 40, 40, 41 };
//then the call of NumUnique(list) should return 9 because this list has 9
//unique values (5, 7, 8, 22, 23, 31, 35, 40 and 41). It is possible that
//the list might not have any duplicates. For example if list instead stored
...
namespace CodeStepByStep_CSharp.Arrays
{
    ...
    {
        public static int RunUnique(int[] a1)
        {
            int uniqueValue = 1;
